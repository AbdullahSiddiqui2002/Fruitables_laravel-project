                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                       <div class="navbar-nav mx-auto">
                            ...
                            <a href="/add-product" class="nav-item nav-link active">Add Product</a>
                        ...
                        <div class="col-lg-12">
                            <form action="/createproduct" method="post" enctype="multipart/form-data">
                                ...
                                <textarea class="w-100 form-control border-0 mb-4 mt-4" rows="5" cols="10"
                                    placeholder="Enter Product Description" name="product_description" value="{{ old('product_description') }}"></textarea>
                                ...
                                @error('product_price')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                <select class="w-100 form-control border-0 py-3 mb-4 mt-4" name="category_id"
                                    id="" value="{{ old('category_id') }}">
                                    <option class="w-100 form-control border-0 py-3 mb-4" value="" disabled
                                        selected>Choose Product Category</option>
                                    @foreach ($categories as $cat)
                                        <option class="w-100 form-control border-0 py-3 mb-4"
                                ...
                                <button class="w-100 btn form-control border-secondary py-3 mt-4 bg-white text-primary"
                                    name="addproduct" type="submit">Add Product</button>
                            </form>
                        </div>
                    </div>
                </div>
