    ...
    <body>
        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                ...
                <form action="/checkoutdetails" method="post" enctype="multipart/form-data">
                     @csrf
                    <div class="row g-5">
                        <div class="col-md-12 col-lg-6 col-xl-7">
                            ...
                            @enderror
                            <div class="form-item">
                                <textarea name="notes" class="form-control mt-3" spellcheck="false" cols="30" rows="11" placeholder="Order Notes (Optional)" value="{{ old('product_name') }}"></textarea>
                            </div>
                            <input type="hidden" name="cartdetails" value="{{ json_encode($cartdetail) }}">
                            <div class="form-item pt-4 mt-2">
                                                    ...
                                                    <tr class="text-center">
                                                        <th scope="row">
                                                            <div class="d-flex align-items-center mt-2">
                                                                <img src="/img/{{ $product->image }}" class="img-fluid rounded-circle mx-auto" style="width: 90px; height: 90px;" alt="">
                                                            </div>
                                                        </th>
                                                        <td class="py-5">{{ $product->name }}</td>
                                                        <td class="py-5">Rs {{ $product->price }}</td>
