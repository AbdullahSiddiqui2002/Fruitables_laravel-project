                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-7">
                            <form action="/contactform" method="post" enctype="multipart/form-data">
                                ...
                                @enderror
                                <input type="email" class="w-100 form-control border-0 py-3 mb-4 mt-4" placeholder="Enter Your Email" name="email" value="{{ old('email') }}">
                                @error('email')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                <textarea class="w-100 form-control border-0 mb-4 mt-4" rows="5" cols="10" placeholder="Your Message" name="message" value="{{ old('message') }}"></textarea>
                                @error('message')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                <button class="w-100 btn form-control border-secondary py-3 bg-white text-primary mt-4" name="contact_btn" type="submit">Submit</button>
                            </form>
                        </div>
                        <div class="col-lg-5">
