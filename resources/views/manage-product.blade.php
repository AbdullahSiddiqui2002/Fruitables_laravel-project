...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="d-flex m-3 me-0">
                            ...
                            <a href="/cart" class="position-relative me-4 my-auto">
                                ...
                                <span
                                    ...
                                    style="top: -5px; left: 15px; height: 20px; min-width: 20px;">{{ $cartItemCount, session('cartItemCount', 0) }}</span>
                            </a>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Manage Product</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="/">Home</a></li>
                <li class="breadcrumb-item active text-white">Manage Product</li>
            </ol>
        </div>
                ...
                <script>
                    ...
                    function displayProducts(pageNumber, productsPerPage) {
                        ...
                        for (var i = startIndex; i < Math.min(endIndex, products.length); i++) {
                            ...
                            html +=
                                '<div class="p-4 border border-secondary border-start-0 border-end-0 border-bottom-0 rounded-bottom" style="height: 250px;">';
                            html += '<h4>' + prod.name + '</h4>';
                            html += '<p>' + prod.description + '</p>';
                            html += '<div>';
                            html += '<p class="text-dark fs-5 fw-bold mb-2">Rs ' + prod.price + '</p>';
                            html += '<a href="/edit-product/' + prod.id +
                                '" class="btn btn-primary me-2"><i class="fa fa-edit text-light"></i></a>';
                            html += '<a href="/deleteproduct/' + prod.id +
                                '" class="btn btn-danger"><i class="fa fa-trash text-light"></i></a>';
                            html += '</div>';
                            html += '</div>';
                            html += '</div>';
                            html += '</div>';
