    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            ...
            <ol class="breadcrumb justify-content-center mb-0">
                ...
                <li class="breadcrumb-item"><a href="/search?query=&search">Shop</a></li>
                    ...
                    <div class="col-lg-8 col-xl-9">
                        <div class="row g-4">
                            @if ($status = Session::get('success'))
                                @if ($status == 'Added to cart successfully.')
                            ...
                            <div class="col-lg-6">
                                ...
                                <form action="/addtocart" method="post" enctype="multipart/form-data" id="add-to-cart-form">
                                    @csrf
