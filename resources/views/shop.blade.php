            ...
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                ...
                <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                    <div class="navbar-nav mx-auto">
                            ...
                            <a href="/search?query=&search" class="nav-item nav-link active">Shop</a>
                ...
                <div class="col-lg-12">
                    <div class="row g-4">
                        <div class="col-xl-3">
                            ...
                            <form action="/search" method="get" class="input-group w-100 mx-auto d-flex">
                                <input type="text" name='query' class="form-control p-3" placeholder="keywords"
                                    aria-describedby="search-icon-1">
                                <input type="submit" id="search-icon-1" name='search' class="input-group-text p-3"
                                    class="fa fa-search">
                            </form>
                            {{-- </div> --}}
                        </div>
                        ...
                        <div class="col-lg-3 pt-4">
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    ...
                                    <div class="d-flex align-items-center justify-content-start mb-2">
                                        <div class="rounded me-4" style="width: 100px; height: 100px;">
                                            <img src="/img/b8bdddabafd4892124d854dfecdb4a63.jpg"
                            ...
                            <div class="row g-4 justify-content-center">
                                ...
                                <script>
                                    ...
                                    function displayProducts(pageNumber, productsPerPage) {
                                        ...
                                        var products = @json($allproductsforshop);
                                        var query = @json($search);
                                        var html = '';
                                        if (products.length === 0) {
                                            html += '<div class="col-12 mb-5"><h3>Search result for '+query+'</h3></div>';
                                            html += '<div class="col-12 text-center my-5"><h1>No record found</h1></div>';
                                        } else {
                                            if(!query == ""){
                                                html = '<div class="col-12 mb-3"><h3>Search result for '+query+'</h3></div>';
                                            }                 
                                    ...
                                    generatePagination(@json(count($allproductsforshop)), productsPerPage);
                                </script>
                            </div>
                        </div>
                    </div>
