                ...
                <div class="col-md-12 col-lg-5">
                    <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            ...
                            <div class="carousel-item rounded">
                                <img src="/img/hero-img-3.jpg" class="img-fluid w-100 h-100 rounded"
                                    alt="Second slide">
                                <a href="#" class="btn px-4 py-2 text-white rounded">Breads</a>
                            </div>
                            <div class="carousel-item rounded">
                                <img src="/img/hero-img-4.jpg" class="img-fluid w-100 h-100 rounded"
                                    alt="Second slide">
                ...
                <div class="tab-content">
                    ...
                    <script>
                        ...
                        function displayProducts(pageNumber, productsPerPage) {
                            ...
                            var products = @json($allproducts);
                            var html = '';
                            for (var i = startIndex; i < Math.min(endIndex, products.length); i++) {
                                var prod = products[i];
                                html += '<div class="col-md-6 col-lg-4 col-xl-3">';
                                html += '<div class="rounded position-relative fruite-item border border-secondary">';
                                html += '<div class="fruite-img">';
                                html += '<img src="/img/' + prod.image +
                                ...
                                html += '<div>';
                                html += '<p class="text-dark fs-5 fw-bold mb-2">Rs ' + prod.price + '</p>';
                                html += '<a href="/product-detail/' + prod.id +
                        ...
                        function generatePagination(totalProducts, productsPerPage) {
                            var totalPages = Math.ceil(totalProducts / productsPerPage);
                            var html = '';
                            for (var i = 1; i <= totalPages; i++) {
                                html += '<button class="btn btn-link" onclick="displayProducts(' + i + ',' + productsPerPage + ')">' + i +
                                    '</button>';
                            }
                        ...
                        displayProducts(1, productsPerPage);
                        generatePagination(@json(count($allproducts)), productsPerPage);
                    </script>
                                        ...
                                        @if ($prod['category'] == 4)
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div
                                                    ...
                                                    <div
                                                        class="p-4 border border-secondary border-start-0 border-end-0 border-bottom-0 rounded-bottom">
                                                        <h4>{{ $prod['name'] }}</h4>
                ...
                <div class="col-md-6 col-lg-4">
                    <a href="#">
                        <div class="service-item bg-secondary rounded border border-secondary">
                            <img src="img/b8bdddabafd4892124d854dfecdb4a63.jpg" class="img-fluid rounded-top w-100"
                                style="height: 300px;" alt="">
                            <div class="px-4 rounded-bottom">
                                <div class="service-content bg-primary text-center p-4 rounded">
                                    <h5 class="text-white">Fresh Breads</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    <a href="#">
                        <div class="service-item bg-dark rounded border border-dark">
                            <img src="img/featur-2.jpg" class="img-fluid rounded-top w-100" style="height: 300px;"
                                alt="">
                            <div class="px-4 rounded-bottom">
                ...
                <div class="col-md-6 col-lg-4">
                    <a href="#">
                        <div class="service-item bg-primary rounded border border-primary">
                            <img src="img/featur-3.jpg" class="img-fluid rounded-top w-100" style="height: 300px;"
                                alt="">
                            <div class="px-4 rounded-bottom">
                                <div class="service-content bg-secondary text-center p-4 rounded">
                                    <h5 class="text-white">Exotic Vegitable</h5>
                                    <h3 class="mb-0">Discount Rs 30</h3>
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    @if ($prod['price'] < 100)
                        <div class="border border-primary rounded position-relative vesitable-item">
                            <div class="vesitable-img">
                                <img src="/img/{{ $prod->image }}" style="height: 200px;"
                                    class="img-fluid w-100 rounded-top" alt="">
                            </div>
                            @if ($prod['category'] == 3)
                                <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                                    style="top: 10px; left: 10px;">Fruit</div>
                            @elseif ($prod['category'] == 4)
                                <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                                    style="top: 10px; left: 10px;">Vegetable</div>
                            @elseif ($prod['category'] == 5)
                                <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                                    style="top: 10px; left: 10px;">Bread</div>
                            @else
                                <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                            ...
                            @endif
                            <div
                                class="p-4 rounded-bottom border border-primary border-start-0 border-end-0 border-bottom-0">
                                <h4>{{ $prod['name'] }}</h4>
                                <p>{{ $prod['description'] }}</p>
                                <div class="d-flex justify-content-between flex-lg-wrap">
                                    <p class="text-dark fs-5 fw-bold mb-0">Rs {{ $prod['price'] }}</p>
                                    <a href="/product-detail/{{ $prod['id'] }}"
                                        class="btn border border-secondary rounded-pill px-3 text-primary"><i
            ...
            <div class="row g-4 align-items-center">
                <div class="col-lg-6">
                    <div class="py-4">
                        ...
                        <p class="mb-4 text-dark">Sweet, crunchy, versatile; rich in antioxidants.</p>
                        <a href="#"
                    ...
                    <div class="position-relative">
                        ...
                        <div class="d-flex align-items-center justify-content-center bg-white rounded-circle position-absolute"
                            ...
                            <div class="d-flex flex-column">
                                <span class="h4 mb-0">Rs 400</span>
                                <span class="h5 text-muted mb-0">kg</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="p-4 rounded bg-light">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <img src="/img/{{ $prod->image }}" class="img-fluid rounded-circle w-100"
                                            alt="">
                                    </div>
                                    <div class="col-6">
                                        <a href="#" class="h5">{{ $prod['name'] }}</a>
                                        ...
                                        <h4 class="mb-3">Rs {{ $prod['price'] }}</h4>
                                        <a href="/product-detail/{{ $prod['id'] }}"
                                            class="btn border border-secondary rounded-pill px-3 text-primary"><i
                                                class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                                    </div>
            ...
            <div class="row g-4 my-4">
                @foreach ($allproducts as $prod)
                    @if ($prod['price'] >= 130 && $prod['price'] <= 180)
                        <div class="col-md-6 col-lg-6 col-xl-3">
                            <div class="text-center">
                                <img src="/img/{{ $prod->image }}" class="img-fluid rounded border border-primary"
